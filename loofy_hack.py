#Decompiled by Shuaib.Algaddafi
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.facebook.com/luna.gonzalez.3386')
                time.sleep(2)
                menu()
